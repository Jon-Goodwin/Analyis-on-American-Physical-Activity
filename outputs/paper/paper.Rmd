...
# Model {#Model}
  ...
  Figure \@ref(fig:fig5) shows the relationship between 150min of Aerobics training and Muscle Training compared to the rate of Obesity.
...
knitr::kable(head(df.new4),booktabs = TRUE, align = "c", caption = "Excerpt of Figure 1") %>% 
kable_styling(full_width = F) %>%
kable_styling(latex_options = "HOLD_position")
```
