...
knitr::kable(head(df.new2),booktabs = TRUE, align = "c", caption = "Excerpt of dataset") %>% 
kable_styling(full_width = F) %>%
kable_styling(latex_options = "HOLD_position")
```
...
knitr::kable(head(df.new4),booktabs = TRUE, align = "c", caption = "Excerpt of Chart 2") %>% 
kable_styling(full_width = F) %>%
kable_styling(latex_options = "HOLD_position")
```
...
knitr::kable(head(df.new5),booktabs = TRUE, align = "c", caption = "Excerpt of dataset") %>% 
kable_styling(full_width = F) %>%
kable_styling(latex_options = "HOLD_position")
```
